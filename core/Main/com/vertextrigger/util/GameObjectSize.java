...
public enum GameObjectSize {
	BULLET_SIZE(0.5f, 0.5f, 0.25f, 0.25f, 0.26f, 0.2f), PLAYER_SIZE(2.5f, 4.5f, 0.5f, 1.5f, 1.9f, 2.2f), POKER_BODY_SIZE(1.3f, 4.1f, 0.6f, 1.5f, 2f,
			2f), PORTAL_SIZE(1.5f, 4f, 0.5f, 1.5f, 2f, 2f), // Sprite is bigger
			// oval & body is
			// smaller rectangle
			// that fits inside
			// the sprite
