...
public abstract class MovingPlatform implements Entity {
	...
	/**
	 * Initialises the physical properties of the platform's physical body Sets platforms's sprite Sets the path of the platform to move
	 *
	 * @param world
	 *            the moving platform will reside in
	 * @param sprite
	 *            platform's image
	 * @param coordinates
	 *            is the path, series of x & y coordinates, the platform moves
	 */
	public MovingPlatform(final World world, final Sprite sprite, final Array<Vector2> coordinates) {
	...
	/**
	 * Create moving platform's physical body & physical properties. Each platform type can set a specific identifier label to it's fixture
	 *
	 * @param world
	 *            the moving platform will reside in
	 * @param position
	 *            of moving platform in game world
	...
	/**
	 * Moves the platform further along its predefined path with the distance moved dependent on the delta. Delta is needed for frame rate independent
	 * movement. Returns sprite after it's position has been updated.
	 *
	 * @param delta
